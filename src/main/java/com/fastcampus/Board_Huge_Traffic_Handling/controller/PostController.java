...
import com.fastcampus.Board_Huge_Traffic_Handling.service.impl.PostServiceImpl;
...
public class PostController {
    ...
    public ResponseEntity<CommonResponse<List<PostDTO>>> myPostInfo(String accountId) {
        ...
        List<PostDTO> postDtoList = postService.getMtPosts(memberInfo.getId());
    ...
    public ResponseEntity<CommonResponse<PostResponse>> updatePosts(String accountId,
        ...
        CommonResponse commonResponse = new CommonResponse(HttpStatus.OK, "SUCCESS", "updatePoasts", postDTO);
        return ResponseEntity.ok(commonResponse);
    }

    @DeleteMapping("{postId}")
    @LoginCheck(type = LoginCheck.UserType.USER)
    public ResponseEntity<CommonResponse<PostDeleteRequest>> deltePosts(String accountId,
                                                                        @PathVariable(name = "postId") int postId,
    ...
    public ResponseEntity<CommonResponse<TagDTO>> registerPostTag(String accountId, @RequestBody TagDTO tagDTO) {
        ...
        CommonResponse commonResponse = new CommonResponse<>(HttpStatus.OK, "SUCCESS", "registerPostComment", tagDTO);
        return ResponseEntity.ok(commonResponse);
    }
