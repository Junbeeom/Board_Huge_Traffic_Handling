package com.fastcampus.Board_Huge_Traffic_Handling.aop;
...
public class LoginCheckAspect {
    @Around("@annotation(com.fastcampus.Board_Huge_Traffic_Handling.aop.LoginCheck) && @ annotation(loginCheck)")
